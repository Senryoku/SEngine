	...
	virtual void update() override
	{
		...
		if(!OnlyOnce)
		{
			...
			for(int i = 0; i < 6; ++i)
			{
				...
				_probeFramebuffer.getColor(1).bindImage(1, 0, GL_FALSE, i, GL_READ_ONLY, GL_RGBA32F);
				_probeFramebuffer.getColor(2).bindImage(2, 0, GL_FALSE, i, GL_READ_WRITE, GL_RGBA32F);
