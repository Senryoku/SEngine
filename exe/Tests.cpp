...
public:
	...
	virtual void run_init() override
	{
		...
		*/
		...
		//_testMesh = Mesh::load("in/3DModels/SketchUp/Test.obj");
	...
	bool scene(Ray r, glm::vec3& p, glm::vec3& n, glm::vec3& c)
	{
		float depth = 1000.0;
		bool b = false;
		b = trace(r, Sphere{glm::vec3(0.0, 10.0, 0.0), 5.0}, depth, p, n) || b;
		b = trace(r, Sphere{glm::vec3(20.0, 10.0, 0.0), 5.0}, depth, p, n) || b;
		b = trace(r, Plane{glm::vec3(0.0), glm::vec3(0.0, 1.0, 0.0)}, depth, p, n) || b;
		...
		b = trace(r, Plane{glm::vec3(-0.0, 0.0, 50.0), glm::vec3(0.0, 0.0, -1.0)}, depth, p, n) || b;
		/*
		for(auto part : _testMesh)
		{
			b = trace(r, *part, p, n) || b;
		}
		*/
		// Lights
		const Sphere Lights[]{
