...
public:
	...
	virtual void run_init() override
	{
		...
		_scene.add(MeshInstance(chunk_mesh, glm::scale(glm::translate(glm::mat4(1.0), glm::vec3(0.0, 0.0, 0.0)), glm::vec3(1.0))));
		_scene.add(MeshInstance(chunk_mesh, glm::scale(glm::translate(glm::mat4(1.0), glm::vec3(128.0, 0.0, 0.0)), glm::vec3(1.0))));
		_scene.add(MeshInstance(chunk_mesh, glm::scale(glm::translate(glm::mat4(1.0), glm::vec3(-128.0, 0.0, 0.0)), glm::vec3(1.0))));
